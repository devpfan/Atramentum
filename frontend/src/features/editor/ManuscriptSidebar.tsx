          ...
          return (
            <div key={chapter.id} className="space-y-1">
              ...
              >
                ...
                <div className="flex items-center gap-1 transition-opacity shrink-0 opacity-100 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100">
                  <button 
                  ...
                  {(chapter.scenes || []).map(scene => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="p-1 hover:bg-red-500/20 hover:text-red-400 text-[var(--color-text-secondary)] rounded transition-opacity shrink-0 opacity-100 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover/scene:opacity-100"
